                    ...
                    <div className="md:w-3/4">
                        <div className="p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-700 rounded-md">
                            ...
                            <ul className="list-unstyled text-slate-400 mt-4">
                                <li className="flex mt-2"><i className="uil uil-arrow-right text-emerald-600 align-middle ltr:mr-2 rtl:ml-2"></i>Digital Marketing Solutions for Tomorrow</li>
                                <li className="flex mt-2"><i className="uil uil-arrow-right text-emerald-600 align-middle ltr:mr-2 rtl:ml-2"></i>Our Talented & Experienced Marketing Agency</li>
                                <li className="flex mt-2"><i className="uil uil-arrow-right text-emerald-600 align-middle ltr:mr-2 rtl:ml-2"></i>Create your own skin to match your brand</li>
                                <li className="flex mt-2"><i className="uil uil-arrow-right text-emerald-600 align-middle ltr:mr-2 rtl:ml-2"></i>Digital Marketing Solutions for Tomorrow</li>
                                <li className="flex mt-2"><i className="uil uil-arrow-right text-emerald-600 align-middle ltr:mr-2 rtl:ml-2"></i>Our Talented & Experienced Marketing Agency</li>
                                <li className="flex mt-2"><i className="uil uil-arrow-right text-emerald-600 align-middle ltr:mr-2 rtl:ml-2"></i>Create your own skin to match your brand</li>
                            </ul>
                            ...
                            <div className="mt-8">
                                <a href="#" className="btn bg-emerald-600 hover:bg-emerald-700 text-white rounded-md">Print</a>
                            </div>
                        </div>
                    </div>
                </div>
