...
const Hero = () => {
  const SearchStylingData = [
    {
      id: 1,
      mainDiv: "-top-20 left-1/2 -translate-x-1/2",
      subDiv: "animate-[bounce_2s_infinite]",
      icon: "assets/images/company/facebook-logo.png",
    },
    {
      id: 2,
      mainDiv: "top-[20%] ltr:left-10 rtl:right-10",
      subDiv: "animate-[spin_5s_linear_infinite]",
      icon: "assets/images/company/google-logo.png",
    },
    {
      id: 3,
      mainDiv: "top-[20%] -right-0",
      subDiv: "",
      icon: "assets/images/company/android.png",
    },
    {
      id: 4,
      mainDiv: "top-3/4",
      subDiv: "",
      icon: "assets/images/company/lenovo-logo.png",
    },
    {
      id: 5,
      mainDiv: "top-3/4 -right-0",
      subDiv: "animate-[spin_5s_linear_infinite]",
      icon: "assets/images/company/skype.png",
    },
    {
      id: 6,
      mainDiv: "-bottom-32 left-1/2 -translate-x-1/2",
      subDiv: "animate-pulse",
      icon: "assets/images/company/snapchat.png",
    },
  ];
  const countryData = [
  ...
  const hi = localStorage.getItem("token") === null ? "false" : "true";
  return (
        ...
        <div className="grid grid-cols-1 text-center mt-10 relative">
                    ...
                    <div className="registration-form text-dark text-start">
                      <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-0 gap-6">
                        ...
                        <div className="filter-search-form relative filter-border bg-gray-50">
                          ...
                          <select
                            className="form-select w-full h-full ml-3 bg-gray-50"
                            data-trigger
          ...
          <div className="mt-4">
            <span className="text-slate-400">
              <span className="text-dark">Popular Searches :</span> Designer,
