export const initialValuesEducationDetails = {
  institute: "",
  degree_title: "",
  discipline: "",
  gpa: "",
...
export const initialValuesJobReferences = {
    name: "",
    company: "",
    position: "",
    email: "",
  };
  export const initialValuesProfessionalExperience = {
    company: "",
    job_title: "",
    start_date: "",
    end_date: "",
...
export const genderOptions = [
  ...
  export  const veteran_statusOptions = [
    { value: "Yes", label: "Yes" },
    { value: "No", label: "No" },
  ...
  export const ethnicity_statusOptions = [
