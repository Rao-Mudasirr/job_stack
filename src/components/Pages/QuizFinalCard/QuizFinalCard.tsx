...
const QuizFinalCard = () => {
  ...
  console.log(location, "Final CArd");

  const [quizEnd, setQuizEnd] = useState(location?.state?.data?.attempt);
                    ...
                    <div>
                      ...
                      <dl className="flex justify-evenly mt-6 gap-4 m-8">
                        ...
                        <div className="flex flex-col">
                          ...
                          {quizEnd?.is_passed ? (
                            <dd className="text-sm text-gray-500">Passed</dd>
                          ) : (
                            <dd className="text-sm text-red-500">Failed</dd>
                          )}
                        </div>
                      </dl>
                      <p className="text-lg font-medium text-black-600 mt-6 mb-4">
                        We will get back to you after reviewing your assessment
                      </p>
                    </div>
                  ) : (
                    <h3 className="text-xl font-bold text-red-600 sm:text-xl m-4">
